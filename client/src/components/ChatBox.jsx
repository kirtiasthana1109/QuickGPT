...
// const[mode,setMode]=useState('text') // 'text' ya 'image'
...
//       setPrompt(promptCopy) // revert prompt
//     }
...
//        {/* Three  */}
//        {
//         loading && <div className='loader flex itemscenter gap-1.5'>
